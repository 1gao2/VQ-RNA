...
def to_log(log, params):
    with open(f"../results/ablation/CNN_twoLayer/data{params['data_index']}/seed{params['seed']}.log", "a+") as f:
        f.write(log + '\n')
...
def train_model(train_loader, valid_loader, test_loader, params ,data_variance):
    ...
    for epoch in range(params['epoch']):
        ...
        if valid_acc > best_acc:
            ...
            torch.save(checkpoint, f"../save/ablation/CNN_twoLayer/data{params['data_index']}/seed{params['seed']}.pth")
