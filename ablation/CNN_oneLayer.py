...
class Encoder(nn.Module):
    def __init__(self):
        ...
        # 合并三层卷积的效果到一层卷积
        self.conv = nn.Conv1d(in_channels=4, out_channels=64, kernel_size=4, stride=3, padding=2)
...
class Decoder(nn.Module):
    def __init__(self):
        ...
        # 合并三层反卷积的效果到一层反卷积
        self.deconv = nn.ConvTranspose1d(in_channels=64, out_channels=4, kernel_size=4, stride=3, padding=2)
        # self.deconv = nn.ConvTranspose1d(in_channels=64, out_channels=4, kernel_size=12, stride=6, padding=3, output_padding=3)
