...
def to_log(log, params):
    with open(f"../results/ablation/loss/loss1+loss3/data{params['data_index']}/seed{params['seed']}.log", "a+") as f:
        f.write(log + '\n')
...
def train_model(train_loader, valid_loader, test_loader, params ,data_variance):
    ...
    for epoch in range(params['epoch']):
        ...
        for seq, label in train_loader:
            ...
            # loss = loss_CE * loss1
            # loss = loss_CE*loss1 + vq_loss*loss2
            loss = loss_CE*loss1 + recon_error*loss3
        ...
        if valid_acc > best_acc:
            ...
            torch.save(checkpoint, f"../save/ablation/loss/loss1+loss3/data{params['data_index']}/seed{params['seed']}.pth")
