...
def to_log(log, params):
    with open(f"../results/length/moss_m7g/length1001/data{params['data_index']}/seed{params['seed']}length51.log", "a+") as f:
        f.write(log + '\n')
...
def train_model(train_loader, valid_loader, test_loader, params):
    ...
    for epoch in range(params['epoch']):
        ...
        if valid_acc > best_acc:
            ...
            torch.save(checkpoint, f"../save/length/moss_m7g/length1001/data{params['data_index']}/seed{params['seed']}length51.pth")
