...
class VectorQuantizer(nn.Module):
    ...
    def forward(self, inputs):
        ...
        return vq_loss, quantized, perplexity, encodings, self._embedding.weight
...
class Lucky(nn.Module):
    ...
    def forward(self, x):
        ...
        vq_loss, quantized, perplexity, encodings, codebook_feature= self._vq_vae(z)
        ...
        return out, atts, vq_loss, x_recon, perplexity, quantized, codebook_feature, x_final
