...
import sys
sys.path.append('../')
from comparison.train_other_methods import LSTM
import umap
...
def load_model_and_data():
    ...
    model.load_state_dict(torch.load(f"../save/comparison/LSTM/data{params['data_index']}/seed{params['seed']}.pth")['state_dict'])
...
def draw_umap(x, vlabels):
    ...
    plt.savefig(f'../results/umap/data{index}_LSTM_UMAP.svg', format='svg')
    plt.show()
